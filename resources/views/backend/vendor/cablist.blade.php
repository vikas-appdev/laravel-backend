            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                 @if (count($errors) > 0)
                  ...
                  @endif
                       {!! Form::open(array('action' => 'Admin\VendorController@cablistdetail','method'=>'POST')) !!}
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
   				        ...
   				        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                ...
                                {!! Form::text('cab_type', null, array('placeholder' => 'Cab Type','class' => 'form-control', 'id' => 'cab_type')) !!}
                            </div>
                   ...
                   @if(!empty($cablists))
                    @foreach ($cablists as $i => $cab)
                      <tr>
                          ...
                          <td>{{ $cab->cab_type }}</td>
                          <td>
                              {!! Form::open(['method' => 'DELETE','route' => ['cablist.destroy', $cab->id],'style'=>'display:inline', 'onclick' => 'return confirm("Are You Sure?")']) !!}
