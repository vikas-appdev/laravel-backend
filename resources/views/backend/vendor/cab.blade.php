            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                 @if (count($errors) > 0)
                  ...
                  @endif
                       {!! Form::open(array('action' => 'Admin\VendorController@cabdetail','method'=>'POST')) !!}
                      ...
                      <div id="cat_from">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                ...
                                {!! Form::text('base_price', null, array('placeholder' => 'Base Price','class' => 'form-control', 'id' => 'base_price')) !!}
                            </div>
                        </div>
                          ...
                          <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                ...
                                {!! Form::text('charges_per_distance', null, array('placeholder' => 'Cab Charges / km','class' => 'form-control', 'id' => 'charges_per_distance')) !!}
                            </div>
                        </div>
